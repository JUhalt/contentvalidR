...
`  `[`as.matrix`](https://rdrr.io/r/base/matrix.html)`(``expert_rel``[`[`setdiff`](https://rdrr.io/r/base/sets.html)`(`[`names`](https://rdrr.io/r/base/names.html)`(``expert_rel``)``, ``"expert"``)``]``)``,`\
...
\
`expert_fit``$``results``[`[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`later_retained`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``TRUE``, ``TRUE``, ``TRUE``, ``FALSE``, ``TRUE``, ``FALSE``)`\
[`signal_detection`](https://juhalt.github.io/contentvalidR/reference/signal_detection.md)`(``pretest_supported``, ``later_retained``)`\
`#> $confusion`\
`#>               Actual`\
...
`#> [1] 0.01430588`\
\
`replication_supported`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``TRUE``, ``TRUE``, ``TRUE``, ``FALSE``, ``TRUE``, ``TRUE``)`\
[`reproducibility_phi`](https://juhalt.github.io/contentvalidR/reference/reproducibility_phi.md)`(``pretest_supported``, ``replication_supported``)`\
`#> $table`\
`#>               Pretest2`\
