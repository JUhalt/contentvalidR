...
`sort_fit`` ``<-`` `[`sort_validity`](https://juhalt.github.io/contentvalidR/reference/sort_validity.md)`(``sort_dat``)`\
`sort_sum`` ``<-`` `[`summary`](https://rdrr.io/r/base/summary.html)`(``sort_fit``)`\
`sort_fit``$``results`\
...
\
`sort_fit``$``results``[`[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`rating_fit`` ``<-`` `[`rating_validity`](https://juhalt.github.io/contentvalidR/reference/rating_validity.md)`(``rating_dat``, scale_min ``=`` ``1``, scale_max ``=`` ``5``)`\
`rating_sum`` ``<-`` `[`summary`](https://rdrr.io/r/base/summary.html)`(``rating_fit``)`\
`rating_fit``$``results`\
...
\
`rating_fit``$``results``[`[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`expert_rel_matrix`` ``<-`` `[`as.matrix`](https://rdrr.io/r/base/matrix.html)`(``expert_rel``[`[`setdiff`](https://rdrr.io/r/base/sets.html)`(`[`names`](https://rdrr.io/r/base/names.html)`(``expert_rel``)``, ``"expert"``)``]``)`\
`expert_fit`` ``<-`` `[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(`\
`  ``expert_rel_matrix``,`\
`  mode ``=`` ``"relevance"``,`\
`  lo ``=`` ``1``,`\
`  hi ``=`` ``4`\
`)`\
`expert_sum`` ``<-`` `[`summary`](https://rdrr.io/r/base/summary.html)`(``expert_fit``)`\
`expert_fit``$``results`\
...
`expert_ess_matrix`` ``<-`` `[`as.matrix`](https://rdrr.io/r/base/matrix.html)`(``expert_ess``[`[`setdiff`](https://rdrr.io/r/base/sets.html)`(`[`names`](https://rdrr.io/r/base/names.html)`(``expert_ess``)``, ``"expert"``)``]``)`\
`ess_fit`` ``<-`` `[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(``expert_ess_matrix``, mode ``=`` ``"essentiality"``)`\
`ess_fit``$``results`\
...
`ioc_fit`` ``<-`` `[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(``expert_ioc``, mode ``=`` ``"congruence"``)`\
`ioc_fit``$``results`\
