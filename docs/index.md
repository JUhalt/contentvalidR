...
`remotes``::`[`install_github`](https://remotes.r-lib.org/reference/install_github.html)`(``"JUhalt/contentvalidR"``)`
...
\
`sort_dat`` ``<-`` `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(`\
`  item ``=`` `[`rep`](https://rdrr.io/r/base/rep.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Clear 1"``, ``"Clear 2"``, ``"Needs review"``)``, each ``=`` ``20``)``,`\
`  rater ``=`` `[`rep`](https://rdrr.io/r/base/rep.html)`(``1``:``20``, ``3``)``,`\
`  target_construct ``=`` ``"A"``,`\
`  assigned_construct ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`    `[`rep`](https://rdrr.io/r/base/rep.html)`(``"A"``, ``18``)``, `[`rep`](https://rdrr.io/r/base/rep.html)`(``"B"``, ``2``)``,`\
`    `[`rep`](https://rdrr.io/r/base/rep.html)`(``"A"``, ``16``)``, `[`rep`](https://rdrr.io/r/base/rep.html)`(``"B"``, ``4``)``,`\
`    `[`rep`](https://rdrr.io/r/base/rep.html)`(``"A"``, ``12``)``, `[`rep`](https://rdrr.io/r/base/rep.html)`(``"B"``, ``8``)`\
`  ``)`\
`)`\
\
`fit`` ``<-`` `[`sort_validity`](https://juhalt.github.io/contentvalidR/reference/sort_validity.md)`(``sort_dat``)`\
`fit`\
...
\
[`sort_validity`](https://juhalt.github.io/contentvalidR/reference/sort_validity.md)`(``sort_dat``, orbiting_r ``=`` ``.42``)``$``scale_summary`\
...
[`colquitt_benchmarks`](https://juhalt.github.io/contentvalidR/reference/colquitt_benchmarks.md)`(``"csv"``, orbiting_r ``=`` ``.42``)`\
...
\
[`sort_validity`](https://juhalt.github.io/contentvalidR/reference/sort_validity.md)`(``sort_dat``, judge_type ``=`` ``"expert"``)``$``scale_summary`\
`#>   target n_items n_items_usable n_retain n_review  mean_psa psa_strength`\
...
\
[`sort_power`](https://juhalt.github.io/contentvalidR/reference/sort_power.md)`(``N ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``20``, ``30``, ``40``)``, true_p ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``.60``, ``.70``, ``.80``)``)`\
...
\
[`compute_psa`](https://juhalt.github.io/contentvalidR/reference/compute_psa.md)`(``sort_dat``)`\
...
[`compute_csv`](https://juhalt.github.io/contentvalidR/reference/compute_csv.md)`(``sort_dat``)`\
...
[`csv_binom_test`](https://juhalt.github.io/contentvalidR/reference/csv_binom_test.md)`(``n_c ``=`` ``15``, N ``=`` ``20``)`\
`#> $p.value`\
`#> [1] 0.02069473`\
`#> `\
`#> $estimate`\
...
[`interpret_colquitt`](https://juhalt.github.io/contentvalidR/reference/interpret_colquitt.md)`(``.70``, ``"csv"``)`\
...
\
[`set.seed`](https://rdrr.io/r/base/Random.html)`(``12``)`\
`rating_dat`` ``<-`` `[`expand.grid`](https://rdrr.io/r/base/expand.grid.html)`(`\
`  item ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"A1"``, ``"A2"``, ``"B1"``)``,`\
`  rater ``=`` ``1``:``20``,`\
...
`  `[`pmin`](https://rdrr.io/r/base/Extremes.html)`(``5``, `[`pmax`](https://rdrr.io/r/base/Extremes.html)`(``1``, `[`round`](https://rdrr.io/r/base/Round.html)`(`[`rnorm`](https://rdrr.io/r/stats/Normal.html)`(`[`nrow`](https://rdrr.io/r/base/nrow.html)`(``rating_dat``)``, ``2.1``, ``.7``)``)``)``)`\
`)`\
\
`rfit`` ``<-`` `[`rating_validity`](https://juhalt.github.io/contentvalidR/reference/rating_validity.md)`(``rating_dat``, scale_min ``=`` ``1``, scale_max ``=`` ``5``)`\
`rfit`\
...
[`summary`](https://rdrr.io/r/base/summary.html)`(``rfit``)`\
...
`#> 2            2.10       5 0.53125`\
`#> 3            2.00       5 0.63750`\
[`anova_content`](https://juhalt.github.io/contentvalidR/reference/anova_content.md)`(``rating_dat``)`\
...
`    ``4``,``3``,``4``,``4``,``3``,``4``)``,`\
`  nrow ``=`` ``6``,`\
`  dimnames ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``NULL``, `[`c`](https://rdrr.io/r/base/c.html)`(``"Item1"``, ``"Item2"``, ``"Item3"``)``)`\
`)`\
\
`efit`` ``<-`` `[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(`\
`  ``expert_ratings``,`\
`  mode ``=`` ``"relevance"``,`\
`  lo ``=`` ``1``, hi ``=`` ``4`\
`)`\
...
[`summary`](https://rdrr.io/r/base/summary.html)`(``efit``)`\
...
\
[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(``expert_ratings``, mode ``=`` ``"relevance"``,`\
...
\
[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(``10``, ``8``, ``6``)``,`\
`  mode ``=`` ``"essentiality"``,`\
`  N ``=`` ``12`\
`)`\
`#> contentvalidR expert-panel analysis`\
...
\
`ioc_dat`` ``<-`` `[`expand.grid`](https://rdrr.io/r/base/expand.grid.html)`(`\
`  item ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"I1"``, ``"I2"``)``,`\
`  judge ``=`` ``1``:``4``,`\
`  objective ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"A"``, ``"B"``)`\
`)`\
`ioc_dat``$``target_objective`` ``<-`` `[`ifelse`](https://rdrr.io/r/base/ifelse.html)`(``ioc_dat``$``item`` ``==`` ``"I1"``, ``"A"``, ``"B"``)`\
`ioc_dat``$``score`` ``<-`` `[`ifelse`](https://rdrr.io/r/base/ifelse.html)`(`\
`  ``ioc_dat``$``objective`` ``==`` ``ioc_dat``$``target_objective``, ``1``, ``-``1`\
`)`\
\
[`expert_validity`](https://juhalt.github.io/contentvalidR/reference/expert_validity.md)`(``ioc_dat``, mode ``=`` ``"congruence"``)`\
`#> contentvalidR expert-panel analysis`\
`#> -----------------------------------`\
`#> Mode: congruence `\
...
\
[`aikens_v`](https://juhalt.github.io/contentvalidR/reference/aikens_v.md)`(``expert_ratings``, lo ``=`` ``1``, hi ``=`` ``4``)`\
...
[`cvi`](https://juhalt.github.io/contentvalidR/reference/cvi.md)`(``expert_ratings`` ``>=`` ``3``)`\
...
[`ioc`](https://juhalt.github.io/contentvalidR/reference/ioc.md)`(``ioc_dat``[`[`c`](https://rdrr.io/r/base/c.html)`(``"item"``, ``"judge"``, ``"objective"``, ``"score"``)``]``)`\
...
\
`judge_ratings`` ``<-`` `[`rbind`](https://rdrr.io/r/base/cbind.html)`(`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``4``, ``4``, ``3``, ``2``, ``2``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``4``, ``3``, ``4``, ``2``, ``1``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``3``, ``4``, ``4``, ``1``, ``2``)``,`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(``3``, ``4``, ``4``, ``4``, ``2``, ``2``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``4``, ``4``, ``4``, ``2``, ``1``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``3``, ``4``, ``3``, ``1``, ``2``)``,`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``4``, ``3``, ``4``, ``2``, ``2``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``2``, ``2``, ``2``, ``2``, ``1``, ``1``)`\
`)`\
[`dimnames`](https://rdrr.io/r/base/dimnames.html)`(``judge_ratings``)`` ``<-`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`paste0`](https://rdrr.io/r/base/paste.html)`(``"Judge"``, ``1``:``8``)``, `[`paste0`](https://rdrr.io/r/base/paste.html)`(``"Item"``, ``1``:``6``)``)`\
\
`judge_fit`` ``<-`` `[`judge_validity`](https://juhalt.github.io/contentvalidR/reference/judge_validity.md)`(``judge_ratings``, lo ``=`` ``1``, hi ``=`` ``4``)`\
`judge_fit``$``results``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"judge"``, ``"mean_rating"``, ``"severity_raw"``,`\
...
\
`gt`` ``<-`` `[`gtheory_content`](https://juhalt.github.io/contentvalidR/reference/gtheory_content.md)`(``judge_ratings``)`\
`gt``$``coefficients`\
...
\
`assignments`` ``<-`` `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(`\
`  item ``=`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(``"I"``, ``1``:``7``)``,`\
`  construct ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Autonomy"``, ``"Autonomy"``, ``"Autonomy"``, ``"Autonomy"``,`\
`                ``"Competence"``, ``"Competence"``, ``"Relatedness"``)``,`\
`  stringsAsFactors ``=`` ``FALSE`\
`)`\
\
`domain_fit`` ``<-`` `[`domain_validity`](https://juhalt.github.io/contentvalidR/reference/domain_validity.md)`(`\
`  ``assignments``,`\
`  cell_col ``=`` ``"construct"``,`\
`  domain ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Autonomy"``, ``"Competence"``, ``"Relatedness"``, ``"Belonging"``)`\
`)`\
`domain_fit``$``results``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"cell"``, ``"n_items"``, ``"share"``, ``"recommendation"``)``]`\
...
\
[`expert_power`](https://juhalt.github.io/contentvalidR/reference/expert_power.md)`(``n_experts ``=`` ``3``:``8``, prob ``=`` ``0.9``)``$``results`\
...
\
[`content_report`](https://juhalt.github.io/contentvalidR/reference/content_report.md)`(``efit``, include ``=`` ``"flagged"``)`\
`#> [1] item           N              V              ci_low         ci_high       `\
`#> [6] I_CVI          kappa_mod      recommendation status        `\
...
\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``rfit``, type ``=`` ``"map"``)`

![](reference/figures/README-visualization-2.png)

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``rfit``, type ``=`` ``"profile"``)`

![](reference/figures/README-visualization-3.png)

\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``efit``)`
...
\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(`[`sort_power`](https://juhalt.github.io/contentvalidR/reference/sort_power.md)`(``N ``=`` `[`seq`](https://rdrr.io/r/base/seq.html)`(``10``, ``50``, by ``=`` ``5``)``, true_p ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``.60``, ``.70``, ``.80``)``)``)`
...
\
`sort_path`` ``<-`` `[`system.file`](https://rdrr.io/r/base/system.file.html)`(``"extdata"``, ``"sort_example.csv"``, package ``=`` ``"contentvalidR"``)`\
`bundled_sort`` ``<-`` ``utils``::`[`read.csv`](https://rdrr.io/r/utils/read.table.html)`(``sort_path``, stringsAsFactors ``=`` ``FALSE``)`\
[`sort_validity`](https://juhalt.github.io/contentvalidR/reference/sort_validity.md)`(``bundled_sort``)`
...
`GPL-3`). See the [full
license](https://juhalt.github.io/contentvalidR/LICENSE.md). Copyright
(c) 2025-2026 Joshua Uhalt.
