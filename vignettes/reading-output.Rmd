...
judgements, and they are the most frequently misreported part of this output.
...
An HTC of about 0.83 is labelled `Weak`, while an HTD of about 0.44 in the same
row is labelled `Very Strong`. Read as raw numbers this looks backwards, and it
...
**"The numbers are comparable."** HTC against HTD, Psa against Csv, one index
against another's benchmark: these comparisons are not meaningful.
