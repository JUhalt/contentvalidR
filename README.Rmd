...
**Current stable release: 0.1.0. Development version: 0.1.0.9000, targeting v0.2.0.**

Development plans: [Roadmap](ROADMAP.md) · [v0.2.0 milestone](https://github.com/JUhalt/contentvalidR/milestone/1) · [Open issues](https://github.com/JUhalt/contentvalidR/issues).
...
**contentvalidR** provides quantitative tools for substantive and content-oriented scale pretesting. The package provides three complementary workflows:
