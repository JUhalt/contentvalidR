...
The diagnostic, simulation, and Q-factor helpers remain available while their APIs and methodological scope are being hardened. The three recommended primary workflows are now `sort_validity()`, `rating_validity()`, and `expert_validity()`.
