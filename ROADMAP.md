...
State the deprecation policy and public API stability, which is the 1.0
criterion on [nomologR#53](https://github.com/JUhalt/nomologR/issues/53)
that rests entirely with this package.
